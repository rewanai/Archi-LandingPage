...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'itp.card1.desc': 'Our Socratic AI interviews you to fix logical flaws and finalize your feature list before building.',
    ...
    'itp.m2.title': '"As a business manager, I want to drop in my messy spreadsheet so the chatbot instantly answers client questions about inventory."',
    'itp.m3.header': 'Archi Dev Progress',
    'itp.m3.pending': '1 Task in Progress',
    'itp.m3.active_task': 'Programming and building the smart dashboard...',
    'itp.m3.completed': '3 Steps Completed',
    'itp.m3.done1': 'Secure database (MongoDB) linked',
    'itp.m3.done2': 'APIs written and secured',
    'itp.m3.done3': 'Ran safety and error checks',
    ...
    'hiw.phase01.brand': '',
    'hiw.phase01.descEnd': '',
    'hiw.phase01.url': 'engine://socratic-scoping',
  ...
  ar: {
    ...
    'itp.card1.desc': 'ذكاؤنا الاصطناعي السقراطي يجري مقابلة معك لإصلاح العيوب المنطقية وتحديد قائمة الميزات قبل البناء.',
    ...
    'itp.m2.title': '"بصفتي مدير أعمال، أريد إدراج جدول البيانات المعقد الخاص بي لكي يجيب الروبوت فوراً على أسئلة العملاء حول المخزون."',
    'itp.m3.header': 'تقدم آركي ديف',
    'itp.m3.pending': 'مهمة واحدة قيد التقدم',
    'itp.m3.active_task': 'جاري برمجة وبناء لوحة التحكم الذكية...',
    'itp.m3.completed': 'تم إنجاز ٣ خطوات',
    'itp.m3.done1': 'تم ربط قاعدة البيانات الآمنة (MongoDB)',
    'itp.m3.done2': 'تمت كتابة واجهات البرمجة وتأمينها',
    'itp.m3.done3': 'تم إجراء فحوصات الأمان والأخطاء',
    ...
    'footer.nav.products': 'المنتجات',
    'footer.nav.solutions': 'الحلول',
    'footer.nav.resources': 'الموارد',
    'footer.nav.support': 'الدعم',
