...
const services: ServiceItem[] = [
  {
    ...
    description: 'Our AI analyst conducts a deep Socratic interview to uncover your real business requirements and lock down scope before a single line of code is written.',
    descriptionAr: 'يجري المحلل الذكي مقابلة سقراطية عميقة لكشف متطلبات عملك الحقيقية وتحديد النطاق قبل كتابة سطر واحد من الكود.',
