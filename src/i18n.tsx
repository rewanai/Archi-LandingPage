...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    // ──── Target Audience Section ("Who is Archi for?") ────
    'target.badge': 'Target Audience',
    'target.heading': 'Who is Archi built for?',
    'target.description': 'Whether you are an individual founder launching a new idea, an enterprise modernizing workflows, or need a fully tailored custom solution—Archi has you covered.',
    'target.card1.pill': 'SPEED',
    'target.card1.title': 'Startups & Creators',
    'target.card1.tagline': 'Build apps & websites at lightspeed.',
    'target.card1.bullet1': 'Auto-generated | full-stack code across the entire stack',
    'target.card1.bullet2': 'Automated testing | & zero-configuration hosting',
    'target.card1.bullet3': 'Launch in hours | instead of months',
    'target.card1.cta': 'Build Your App',
    'target.card2.pill': 'SOVEREIGN',
    'target.card2.title': 'Enterprises',
    'target.card2.tagline': 'Custom-integrated AI workflows.',
    'target.card2.bullet1': 'Deploy locally | or on sovereign Omani cloud',
    'target.card2.bullet2': 'Custom models | fine-tuned on your internal codebase',
    'target.card2.bullet3': 'SSO integrations | & enterprise-grade access control',
    'target.card2.cta': 'Request Enterprise Demo',
    'target.card3.pill': 'BESPOKE',
    'target.card3.title': 'Bespoke Projects',
    'target.card3.tagline': 'Complex systems tailored to your needs.',
    'target.card3.bullet1': 'Modernize legacy systems | & hybrid architectures',
    'target.card3.bullet2': 'Direct integration | with local Omani payment gateways',
    'target.card3.bullet3': 'Dedicated support | & custom SLA agreements',
    'target.card3.cta': 'Request Custom Scope',
  },
  ar: {
    // ──── Navbar ────
    'nav.menu': 'القائمة',
    ...
    // ──── Target Audience Section ("Who is Archi for?") ────
    'target.badge': 'الفئة المستهدفة',
    'target.heading': 'لمن تم بناء منصة أركي؟',
    'target.description': 'سواء كنت رائد أعمال يطلق فكرة جديدة، أو مؤسسة تسعى لتطوير سير العمل البرمجي، أو تحتاج إلى حلول مخصصة بالكامل — أركي توفر لك كل ذلك.',
    'target.card1.pill': 'سرعة فائقة',
    'target.card1.title': 'رواد الأعمال والمبدعين',
    'target.card1.tagline': 'ابْنِ تطبيقات الويب والمواقع بسرعة الضوء.',
    'target.card1.bullet1': 'كود تلقائي بالكامل | ومطور بأحدث التقنيات المتاحة',
    'target.card1.bullet2': 'اختبارات آلية | واستضافة سريعة خالية من الإعدادات المعقدة',
    'target.card1.bullet3': 'إطلاق سريع | في ساعات معدودة بدلاً من شهور',
    'target.card1.cta': 'ابدأ بناء تطبيقك',
    'target.card2.pill': 'سيادي ومخصص',
    'target.card2.title': 'المؤسسات والشركات',
    'target.card2.tagline': 'سير عمل ذكاء اصطناعي مدمج ومخصص.',
    'target.card2.bullet1': 'نشر محلي سيادي | بالكامل أو على سحابة عُمانية سيادية',
    'target.card2.bullet2': 'نماذج مخصصة | مدربة على شفرتك البرمجية الخاصة',
    'target.card2.bullet3': 'ربط الهوية الموحد | وصلاحيات وصول متقدمة للمؤسسات',
    'target.card2.cta': 'اطلب عرضاً للمؤسسات',
    'target.card3.pill': 'حلول خاصة',
    'target.card3.title': 'مشاريع خاصة ومخصصة',
    'target.card3.tagline': 'أنظمة معقدة ومصممة خصيصاً لاحتياجاتك.',
    'target.card3.bullet1': 'تحديث الأنظمة القديمة | وبنيات سحابية هجينة معقدة',
    'target.card3.bullet2': 'ربط مباشر ودعم | لبوابات الدفع المحلية (ثواني، إلخ)',
    'target.card3.bullet3': 'دعم فني مخصص | واتفاقيات مستوى خدمة مرنة (SLA)',
    'target.card3.cta': 'اطلب نطاقاً مخصصاً',
  }
};
