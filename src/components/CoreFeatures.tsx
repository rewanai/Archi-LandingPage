                          ...
                          <AnimatePresence mode="wait">
                             ...
                             {activeTab === tabs[0] && (
                                <motion.div
                                   ...
                                   className="w-full h-full bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden flex flex-col border border-zinc-200 p-3 sm:p-4 select-none text-[8px] md:text-[9px] text-zinc-600 font-sans"
                                >
                                   {/* Header */}
                                   <div className="text-start border-b border-zinc-200 pb-2 mb-2 sm:mb-3 shrink-0">
                                      <p className="text-zinc-500 font-medium text-[8px] sm:text-[9px]">
                                         {t('hiw.form.subtitle')}
                                      </p>
                                   </div>
                                   ...
                                   <div className="flex-1 overflow-y-auto space-y-3 pr-0.5 min-h-0 text-start">
                                      ...
                                      <div>
                                         <label className="font-bold text-zinc-800 mb-1 block">
                                            {t('hiw.form.vision')}
                                         </label>
                                         <textarea
                                            disabled
                                            className="w-full bg-zinc-50 border border-zinc-200 rounded-lg p-2 text-zinc-800 placeholder-zinc-400 focus:outline-none resize-none h-11 text-start cursor-default"
                                      ...
                                      <div className="flex flex-col sm:flex-row gap-3 items-end justify-between">
                                         ...
                                         <div className="flex justify-end gap-2 w-full sm:w-auto mt-2 sm:mt-0 shrink-0">
                                            <button className="px-3.5 py-1.5 bg-zinc-100 hover:bg-zinc-200 text-zinc-600 font-semibold rounded-md transition-colors leading-none text-[8.5px]">
                                               {t('hiw.form.cancel')}
                                            </button>
                                            <button className="px-3.5 py-1.5 bg-sky-500 hover:bg-sky-400 text-white font-extrabold rounded-md transition-colors leading-none text-[8.5px]">
                                               {t('hiw.form.generate')}
                                            </button>
                                         </div>
                                      </div>
